...
class ControlNetModelWrapper:
    ...
    def infer_controlnet(self, source_image, prompt, H, W, guidance_scale=7.5, conditioning_scale=1, condition_image=None,
    ...
    def run_noground_pipeline(self, image, i, prompt="",
        ...
        original_pcd = point_clouds.get_point_cloud(src_img_np, inverted_predict_ground_depth, pcd_path=ground_pcd_path + ".pcd")
        # original_pcd = get_point_cloud(src_img_np, ground_depth_map,  pcd_path=ground_pcd_path+".pcd")
